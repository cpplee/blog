		...
		<div id="left_box">
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="http://localhost/blog" class="pos">前台首页</a>
				        </li> 
				    </ul>
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Category/add');?>" class="pos">添加栏目</a>
				        </li> 
				    </ul>  

				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Category/index');?>" class="pos">查看栏目</a>
				        </li> 
				    </ul>   
				</div>
			</div>
			 ...
			 <div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Article/add');?>" class="pos">添加博文</a>
				        </li> 
				    </ul>  
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Article/article');?>" class="pos">博文列表</a>
				        </li> 
				    </ul>
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Article/recycle');?>" class="pos">回收站</a>
				        </li> 
				    </ul>   
				</div>
			</div>
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Comment/index');?>" class="pos">查看评论</a>
				        </li> 
				    </ul>
			 ...
			 <div class="menu_box">
				...
				<div class="text">
				    ...
				    <ul class="con">
				        <li class="nav_u">
				        	<a href="<?php echo U('Index/passwd');?>" class="pos">密码修改</a>
				        </li> 
				    </ul>
